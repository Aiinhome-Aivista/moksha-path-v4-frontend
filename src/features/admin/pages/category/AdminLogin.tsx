...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-100 dark:bg-background-dark overflow-hidden">
      {/* Blurred Background */}
      <div
        className="absolute inset-0 filter blur-md brightness-75"
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-secondary-200 dark:border-secondary-700 bg-white dark:bg-secondary-800 focus:outline-none focus:ring-2 focus:ring-[#e76f20]/40  transition-shadow"
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="btn btn-primary w-full flex items-center justify-center gap-2  text-gray-900 px-5 py-3.5 rounded-xl font-semibold transition-colors shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
