        ...
        <div className="p-4 border-b border-secondary-200 dark:border-secondary-700 flex items-center justify-between gap-4">
          <div className="relative max-w-md flex items-center w-full">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 rounded-md w-full text-primary dark:text-secondary-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#e76f20]/50 transition-shadow text-black disabled:opacity-70 disabled:cursor-not-allowed"
              value={searchQuery}
